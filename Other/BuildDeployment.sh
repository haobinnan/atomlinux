...
#tools
MyInstall_Base "wget vim git git-gui sbsigntool lcab python perl ruby flex bison cmake gperf pesign automake nasm autogen m4 autoconf help2man xorriso texinfo gettext upx-ucl irpas"
#tools
